...
const SingleGif = () => {
  ...
  const shareGif = () => {
    // Assignment
    const gifUrl = gif.url || gif.images.original.url; // Get the URL of the GIF (ensure it exists)
  ...
  const EmbedGif = () => {
    // Assignment
    const embedUrl = gif.embed_url || `https://giphy.com/embed/${gif.id}`;

  // Generate the iframe code for embedding
  const embedCode = `<iframe src="${embedUrl}" width="480" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>`;
